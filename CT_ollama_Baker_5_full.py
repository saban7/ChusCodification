...
EXCEL_FILE_PATH = "/home/msaban/ChusCodification/Context1.xlsx"
...
def main():
    ...
    # Identify the columns that contain codes in the "Context" sheet (F, G → indices 5,6 in Excel → Python 0-based)
    ...
    summary_col = 5      # Embedded media description
    ...
    for code_col in code_columns:
        ...
        for i in range(1, 90):  # Adjust range as needed
            ...
            prompt = (
                ...
                f"For additional context, here is a summary of the preceding content: `{previous_summary}`. "
